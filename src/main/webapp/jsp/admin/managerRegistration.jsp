...
<main>
    ...
    <div class="container">
        <h1><fmt:message key="registerManagerPage.title"/></h1>
        <form action="${pageContext.request.contextPath}/Admin/registrationManager" method="post">
            <div class="form-control">
                <label><fmt:message key="registerPage.firstName"/>
                    <input type="text" placeholder="<fmt:message key="registerPage.firstName.placeHolder"/>"
                           name="firstname" required="required">
                </label>
            </div>
            <div class="form-control">
                <label><fmt:message key="registerPage.lastName"/>
                    <input type="text" placeholder="<fmt:message key="registerPage.lastName.placeHolder"/>"
            ...
            <div class="form-control">
                <label><fmt:message key="registerPage.password"/>
                    <input type="password" placeholder="<fmt:message key="registerPage.password.placeHolder"/>"
                           name="password" required="required">
                </label>
            </div>
            <div class="form-control">
                <label><fmt:message key="registerPage.repassword"/>
                    <input type="password" placeholder="<fmt:message key="registerPage.repassword.placeHolder"/>"
                           name="re-password" required="required">
                </label>
            </div>
            <div class="form-control">
