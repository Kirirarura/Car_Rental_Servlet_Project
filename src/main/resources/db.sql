...
(
    ...
    `description_en`   VARCHAR(50)   NULL     DEFAULT NULL,
    `description_ua`   VARCHAR(50)   NULL     DEFAULT NULL,
    PRIMARY KEY (`c_id`),
...
INSERT INTO booking_status (id, booking_status_name)
...
INSERT INTO car_status (id, car_status_name)
VALUES (1, 'AVAILABLE');
INSERT INTO car_status (id, car_status_name)
VALUES (2, 'RESERVED');
INSERT INTO car_status (id, car_status_name)
VALUES (3, 'UNDER_REPAIR');

INSERT INTO quality_class (id, quality_class_name)
VALUES (1, 'NEW');
INSERT INTO quality_class (id, quality_class_name)
VALUES (2, 'NORMAL');
INSERT INTO quality_class (id, quality_class_name)
